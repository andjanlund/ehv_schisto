...
source("./Code/exp-haz-vul regressions_noIntervention.R")
...
demosNum <- kidsHH %>% 
  summarise(n = n(), age_mean = mean(DEM04), age_sd = sd(DEM04),
...
table(kidsHH$ENF02)
table(kidsHH$ENF02, kidsHH$DEM01.x)
...
table(kidsHH$wealthQuintile1, kidsHH$DEM01.x)
...
# H0: distribution is the same in each group; Chisq = 13.991, df = 4, p = 0.007323
